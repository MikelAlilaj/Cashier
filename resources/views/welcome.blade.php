    ...
    <div id="wrapper">
        ...
        <nav id="sidebar" v-show="$route.path=== '/' ? false : true" style="display: none">
            <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <router-link class="nav-link" to="/all_users">
                ...
                <li class="nav-item">
                    <router-link class="nav-link" to="/today_orders">
                ...
                {{--                        <router-link class="collapse-item" to="/today_orders">Today Order</router-link>--}}
